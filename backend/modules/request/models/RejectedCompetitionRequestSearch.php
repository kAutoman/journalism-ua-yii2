...
/**
 * Class RejectedCompetitionRequestSearch
 *
 * @package backend\modules\request\models
 */
class RejectedCompetitionRequestSearch extends RejectedCompetitionRequest
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = RejectedCompetitionRequestSearch::find();

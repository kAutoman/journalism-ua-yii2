...
/**
 * Class ExpertsHeaderBlock
 * @package common\modules\builder\blocks\jury
 */
class ExpertsHeaderBlock extends BuilderModel
{
    const BUILDER_EXPERTS_HEADER_IMAGE = 'builder_experts_header_image';
    ...
    public function getUploadAttributes(): array
    {
        ...
        return [
            'image' => self::BUILDER_EXPERTS_HEADER_IMAGE,
        ];
    }
    ...
    public function validationRules(): array
    {
        return [
            ...
            [
                ...
                'saveAttribute' => self::BUILDER_EXPERTS_HEADER_IMAGE,
                'skipOnEmpty' => false
            ],
        ];
    }
    ...
    {
        return Yii::t('back/builder', 'Heading experts page');
    }

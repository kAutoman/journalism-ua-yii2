...
/**
 * OffsetPagination represents information relevant to pagination (based on offset) of data items.
 *
 ...
 * (e.g. [[LINK_NEXT]]), and the array values are the corresponding URLs. This property is read-only.
 ...
 */
class OffsetPagination extends BaseObject implements Linkable
{
    /**
     * @var string link rel attribute constant.
     */
    ...
    /**
     * @var int number of items on each page. If it is less than 1,
    ...
    /**
     * Get the data offset. This may be used to set the OFFSET value
    ...
    /**
     * Get the data limit. This may be used to set the LIMIT value
     * for a SQL statement for fetching the current page of data.

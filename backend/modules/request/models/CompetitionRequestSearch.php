...
/**
 * CompetitionRequestSearch represents the model behind the search form about `CompetitionRequest`.
 */
class CompetitionRequestSearch extends CompetitionRequest
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = CompetitionRequestSearch::find();
